...
#     sub_df = dic[uid]
#     values, counts = np.unique(sub_df['Level'].values,return_counts=True)  # ['High' 'Low' 'Medium' 'Not detected'] [ 4 20 26 34]
...
# df.to_csv('protein_category.txt',sep='\t')

df = pd.read_csv('protein_category.txt',sep='\t',index_col=0)
