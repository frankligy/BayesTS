...
df = pd.read_csv('/Users/ligk2e/Downloads/Cosmic_MutantCensus_Tsv_v98_GRCh38/Cosmic_MutantCensus_v98_GRCh38.tsv',sep='\t')
col0 = [] # genes
...
ts = pd.read_csv('/Users/ligk2e/Desktop/full_results_XYZ.txt',sep='\t',index_col=0)
...
for y in combined_df_valid_rel.columns[2:-1]:
    sns.jointplot(data=combined_df_valid_rel,x='BayesTS',y=y,kind='reg',ylim=None)

sns.pairplot(data=combined_df_valid_rel.iloc[:,2:])
plt.savefig('/Users/ligk2e/Desktop/pair.pdf',bbox_inches='tight')
plt.close()
...
stat.to_csv('/Users/ligk2e/Desktop/stat.txt',sep='\t',index=None)
